---
titre: "wgpatrick/dotbeat — docs/recipes-reference.md : 13 recettes exécutables (rolling-sub-bass, reese-bass, acid-303, 808-glide-bass, three-layer-bass-stack, warm-pad-with-air, house-chord-stab, techno-stab, supersaw-trance-lead, pluck-delay-lead, hoover-lead, layered-lead-stack, layered-house-kit) avec chiffres mesurés sur 3 559 patchs Surge"
source: https://raw.githubusercontent.com/wgpatrick/dotbeat/main/docs/recipes-reference.md
...
Fichier généré (presets/recipes.json) du dépôt wgpatrick/dotbeat : chaque recette combine la structure des priors (prose) et des valeurs médianes mesurées sur 3 559 fichiers de patchs Surge (research 141). Les champs (cutoff en Hz, resonance sur l'échelle du moteur dotbeat, attack/decay/release en secondes, osc2Detune en cents) sont ceux du moteur dotbeat, pas de Serum : transposer avec précaution.
