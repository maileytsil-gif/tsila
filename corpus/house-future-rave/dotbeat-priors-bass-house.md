---
titre: "wgpatrick/dotbeat — docs/priors/bass-house.md : 10 recettes de basse house / tech house / deep house (SoundBridge, MusicRadar, Attack Juno-60, Garage Bass, ModeAudio, Repro-1, Tracey Brakes Serum 2, M1-style, DX21, Phased Techno Bass)"
source: https://raw.githubusercontent.com/wgpatrick/dotbeat/main/docs/priors/bass-house.md
...
Compilation secondaire [DOC-lu] : notes de recherche du dépôt wgpatrick/dotbeat (2026-07-26) résumant des tutoriels Attack Magazine, MusicRadar, Sound on Sound, KVR, etc., avec l'URL de chaque recette ; les chiffres sont ceux que ces sources donnent, à vérifier sur la page d'origine avant de s'y fier.
