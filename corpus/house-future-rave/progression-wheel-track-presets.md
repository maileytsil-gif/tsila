---
titre: "sebastiz/progression-wheel — track-presets.js : tempo, tonique, progression et forme d'arrangement de ~680 titres dance (dont Animals, Take It, San Frandisco, Turn Off The Lights, Feel the Volume)"
source: https://raw.githubusercontent.com/sebastiz/progression-wheel/main/src/track-presets.js
...
Fichier de presets JavaScript [DOC] : pour chaque titre, bpm, tonic (0=C … 11=B), progId (progression du catalogue de l'app), baseTemplate (forme d'arrangement) et un « tip » d'analyse. Consulté pour les sections bigroom_, basshouse_, techhouse_, deeptech_, electrohouse_, dutchhouse_. Aucune mélodie transcrite (choix explicite de l'auteur).
