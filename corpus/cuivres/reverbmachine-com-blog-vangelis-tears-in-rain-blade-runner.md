---
titre: "Reverb Machine — Vangelis Tears in Rain"
source: https://reverbmachine.com/blog/vangelis-tears-in-rain-blade-runner/
...
## 
 ...
 Thanks for reading! The Arturia CS-80 V and Prophet-5 V used in my remake are available for free download below. 
...
The following plugins were used in this article. Some links are affiliate links, which help support Reverb Machine.

 Arturia CS-80 V4 
 Arturia Prophet-5 V 
 Arturia Stage-73 V Prophet-5 V and Stage-73 V are both included in 
Arturia V Collection Intro . 
 Valhalla VintageVerb 

 Published on June 6, 2022, updated May 29, 2026 

 Header artwork by Olya Makar.

 You can still read the original 2022 version of this article here .

## Remake Project
 Explore the Tears in Rain remake for yourself with the Ableton Live Project, which includes the synth design, MIDI, automation, arrangement, effects, and custom VP-330 instruments used throughout the remake.
 Requires Ableton Live 11+ and third-party plugins. All tracks are frozen, so you can still explore the projects even if you are missing plugins. See below for the full plugin list.
...
## VP-30
 ...
 The VP-330 strings in this remake were created using the VP-30 pack, sampled from a vintage Roland VP-330 mkII.
