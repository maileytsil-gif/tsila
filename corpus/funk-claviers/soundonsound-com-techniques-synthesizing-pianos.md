---
titre: "soundonsound.com — synthesizing pianos"
source: https://www.soundonsound.com/techniques/synthesizing-pianos
...
## Brightness Response 
 ...
 Figure 13: The filter response for the tail of the note. This means that the filter cutoff frequency must respond to note number (or pitch CV), key velocity, and some form of contour, with the decay rate of the contour responding to the note number (see Figure 13).
