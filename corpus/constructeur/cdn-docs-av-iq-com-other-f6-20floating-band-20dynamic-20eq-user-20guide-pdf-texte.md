---
titre: "Microsoft Word - F6 new cover.docx (texte du PDF, 10 pages)"
source: constructeur/cdn-docs-av-iq-com-other-f6-20floating-band-20dynamic-20eq-user-20guide-pdf.pdf
...
Thank you for choosing Waves. In order to get the most out of your Waves processor, please take some time to read
through this user guide. We also suggest that you become familiar with www.waves.com/support. There you will find an
extensive answer base, the latest tech specs, detailed installation guides, new software updates, and current information
on licensing and registration. Sign up at the support site and you will receive personalized information about your
...
(1) Mono
(2) Stereo
The interfaces of the two components are identical, except that the mono component does not include the Band Mode
switch.
...
assignment is indicated on the Band Marker with a small letter: M (mid), S (side) or no letter (Stereo).

Band Type is selected in the Band Controls row.
...
Release
5–5000 ms
Sets release time for dynamic process of selected band
