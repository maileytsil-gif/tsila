---
titre: "Serum 2.0.23 — tables d’exécution : 343 descripteurs de paramètres (min, max, défaut, options), 59 sources de modulation, listes de filtres et de warps (pycabbage/flp-extract-fxp)"
source: https://raw.githubusercontent.com/pycabbage/flp-extract-fxp/main/docs/s2-runtime-tables.md
