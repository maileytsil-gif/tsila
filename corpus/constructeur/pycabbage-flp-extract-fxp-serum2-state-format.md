---
titre: "Serum 2 — format d’état VST3 (XferJson + zstd + CBOR), inventaire des 162 sections (pycabbage/flp-extract-fxp)"
source: https://raw.githubusercontent.com/pycabbage/flp-extract-fxp/main/docs/serum2-state-format.md
