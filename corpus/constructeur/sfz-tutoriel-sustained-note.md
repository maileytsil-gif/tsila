---
titre: "SFZ Format — tutoriel : Sustained note basics (boucles, enveloppes, CC)"
source: https://raw.githubusercontent.com/sfzformat/sfzformat.github.io/source/docs/tutorials/sustained_note_basics.md
recupere_le: 2026-09-24
mode: texte integral
langue: en
axe: format SFZ ; multisamples ; Serum 2 multisample
skills: studio-grade-brass-sound-design
usage: copie personnelle pour recherche locale (Ollama) ; droits des auteurs cités
---

Source Markdown du site officiel sfzformat.com (dépôt GitHub, branche `source`).
