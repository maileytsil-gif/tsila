---
titre: "Preset OB-Xd « Here Goes Jump » (FMR Patch Book, banque Zynthian) — valeurs normalisées"
source: https://raw.githubusercontent.com/zynthian/zynthian-data/master/presets/lv2/Obxd_000-FMR_Patch_Book.presets.lv2/000-FMR_Patch_Book_Here_Goes_Jump_OB-Xd.ttl
...
<000-FMR_Patch_Book_Here_Goes_Jump_OB-Xd.ttl>
	a pset:Preset ;
	lv2:appliesTo <https://obxd.wordpress.com> ;
	rdfs:label "Here_Goes_Jump_OB-Xd" ;
	lv2:port [
		...
		pset:value 0.4000000059604645
	] , [
		lv2:symbol "lfofrequency" ;
		pset:value 0.1919999569654465
	] , [
		...
		pset:value 0.02799999713897705
	] , [
		lv2:symbol "lfoamount2" ;
		pset:value 0.004000000189989805
	] , [
		lv2:symbol "lfoosc1" ;
		pset:value 1.0
	] , [
		...
		pset:value 0.1559999883174896
	] , [
		lv2:symbol "filterdecay" ;
		pset:value 0.2840000092983246
	] , [
		lv2:symbol "filtersustain" ;
		pset:value 0.0
	] , [
		lv2:symbol "filterrelease" ;
		pset:value 0.4959999918937683
	] , [
		...
		lv2:symbol "pan1" ;
		pset:value 0.4440987110137939
	] , [
		lv2:symbol "pan2" ;
		pset:value 0.5360000133514404
	] , [
		lv2:symbol "pan3" ;
		pset:value 0.4639999866485596
	] , [
		lv2:symbol "pan4" ;
		pset:value 0.5400000214576721
	] , [
		lv2:symbol "pan5" ;
		pset:value 0.4760000109672546
	] , [
		lv2:symbol "pan6" ;
		pset:value 0.5360000133514404
	] , [
		lv2:symbol "pan7" ;
		pset:value 0.4839999973773956
	] , [
		lv2:symbol "pan8" ;
		pset:value 0.531999945640564
	] , [
		lv2:symbol "unused_2" ;
		pset:value 0.0
	] , [
