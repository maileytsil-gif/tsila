# Chaîne de mix tiers (plus de natifs) — valeurs éprouvées sur « deep chill minimal house »

(Valeurs du projet « deep chill minimal house », sept. 2026 ; copie de `../../ableton-live-session/references/mix-chain.md`. Pour un autre morceau, lire sa mémoire projet.)

- **Pistes AUDIO - X** : REQ 6 — coupe-bas (KICK 27 Hz 48 dB, SUB 23 Hz + passe-bas 109 Hz, BASS 40, PIANO 90, NAPPE 120, PAD 160, CLAP 179, CHORDS 190, PERC/PIZZ 200, HOOK/MÉLODIE 239, TEX 300, HATS 399) + une cloche Q 1 de désencombrement (−1,5 à −2,6 dB entre 260 et 900 Hz) ; shelf −1,6 dB 12 kHz sur HATS, −1,1 dB 10 kHz sur HOOK.
...
- **BUS MASTER 3** (mesure/sortie) : Tonal Balance Control 3 → SPAN (Avg 4000 ms, bloc 8192) → L2 (seuil −5,1, plafond −0,4 dBFS, ARC, 24 bits). REF → Main directement (hors limiteur).
