...
- Komplete Kontrol keyboard: **conflict**. This pack says A49; NI records "Komplete Kontrol S48" as declared, with S49 possible and generation unknown. Ask; do not assume A-series and S-series features match. Komplete Kontrol plug-in 3.5.4 (S).
...
| FabFilter Pro-C 3 (3.00) | S | not probed ("to probe", TASKS) | track compression, sidechain | MTOOLS |
...
| Waves L4 Ultramaximizer (V17) | S | not probed | intended true-peak limiter; Gain Match disables Ceiling, so leave it before export | WAVESM |
...
- FabFilter Pro-L 2: not owned (INV: Pro-L and Pro-MB not found in the standard folders). Use L2 (validated) or L4 once probed. Ableton Limiter is excluded from mix and master chains by rule 6.
...
1. Keyboard: A49 (this pack) vs S48/S49 (NI).
...
3. Primary limiter: L4 (this pack) vs L2, the only one validated in CHAIN (L4 not yet probed).
...
5. RazorClip vendor and functions. Pro-C 3 is cited as a primary tool elsewhere in this pack but has not been probed.
