...
- **Keys/modes**: manual DnB sample 82 % minor, G minor 32 %, F minor 21 % [DOC GiantSteps, n = 38]; Beatport roots F, D, E♭ [DOC WhatBPM, auto-keys]. The theory sheet's former "C minor most common" was corrected on 26 Sept 2026 to these data (G/F minor); "D, A, F minor for liquid" remains an unverified convention [COMM]. Liquid chords: maj7, m9 and borrowed chords, e.g. Am9 – Cmaj7 – Em7 – Am9 – Cmaj7sus4/F – E; Am9 and Cmaj7 share notes, only the bass moves; the clean sub follows the chords [DOC-2].
