...
| Techno, minimal/deep tech, melodic house/techno, afro house, melodic dubstep, liquid ou minimal DnB ; robotic bass, vocoder ; reverse, pré-FX, suckback ; QC « label-ready », stems, archive ; APC64, Komplete Kontrol A49, Maschine 3, Analog Obsession | electronic-production-engineer (skill en anglais, v1.4.0 : boucle diagnostic → une modification à la fois, garde de capacité, inventaire du studio, 10 ADN de genres, contrat du bridge LOM, schémas JSON ; Qwen : `ollama/run_skill.py`) → la ligne spécialisée ci-dessus pour exécuter (sound-designer-serum, ingenieur-mixage, live-mix-mastering…) |
