...
- L'utilisateur souhaite les logiciels ET le matériel. Matériel déclaré : Maschine MK3 et clavier « Komplete Kontrol S48 ». La désignation du clavier reste à confirmer (S49 possible, génération inconnue) ; ne pas la corriger silencieusement. Ne pas assimiler MK3, Mikro, Jam et Maschine+, ni claviers A, M, S et générations MK1/MK2/MK3. Vérifier les fonctions supportées pour le couple matériel/logiciel exact.
