...
### BH-4 Wobble LFO
LFO 1 Mode **Trig** (fiche 3), RATE 1/8 (TRIP au besoin), SMOOTH 20–50, DELAY/RISE pour l'onset (« le wobble entre en fondu »), ANCHOR ; MATRIX LFO 1 → CUTOFF 40 % + ENV 2 → CUTOFF 60–100 % (l'enveloppe fait plus que le LFO) ; LP 24 RES 30–60 ; formes sinus / saw descendant / carrée ; **changer le rate toutes les 1–2 mesures, c'est la composition** ; à 126–128, 1/2 est trop lent, viser 1/4 ou 1/8 ; distorsion après le filtre.
